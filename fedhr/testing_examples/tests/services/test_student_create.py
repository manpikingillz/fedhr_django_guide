...
from fedhr.testing_examples.services import student_create
from fedhr.testing_examples.tests.factories import SchoolFactory, SchoolCourseFactory


class StudentCreateTests(TestCase):
    @patch('fedhr.testing_examples.services.students.school_list_school_courses')
    @patch('fedhr.testing_examples.services.students.roster_create')
