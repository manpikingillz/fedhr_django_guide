...
from fedhr.testing_examples.tests.factories import (
    StudentFactory,
    SchoolCourseFactory
)

from fedhr.testing_examples.models import Roster
from fedhr.testing_examples.services import (
    roster_create,
...
class RosterCreateTests(TestCase):
    ...
    @patch('fedhr.testing_examples.services.rosters.roster_validate_period')
